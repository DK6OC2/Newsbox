...
// Local Website URL
const char* local_URL = "newsbox"; //  accesible on "newsbox.local"
...
void handlePostRequest(AsyncWebServerRequest* request, uint8_t* data, size_t len, size_t index, size_t total) {
   ...
   JsonDocument jsonDocument;                                    // creates a json object with 1024 bytes initial capcity
